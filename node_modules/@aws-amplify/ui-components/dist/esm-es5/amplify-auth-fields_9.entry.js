...
var AmplifyPhoneField = /** @class */ (function () {
    ...
    AmplifyPhoneField.prototype.render = function () {
        return (h("div", null, h("amplify-form-field", { label: this.label, type: "tel", hint: this.hint, required: this.required }, h("div", { class: "phone-field", slot: "input" }, h("amplify-country-dial-code", { dialCode: this.dialCode, handleInputChange: this.handleInputChange }), h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    };
