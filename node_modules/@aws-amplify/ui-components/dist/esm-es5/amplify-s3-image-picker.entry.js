...
var AmplifyS3ImagePicker = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        /** Title string value */
        this.headerTitle = I18n.get(Translations.IMAGE_PICKER_TITLE);
        /** Header Hint value in string */
        this.headerHint = I18n.get(Translations.IMAGE_PICKER_HINT);
        /** Placeholder hint that goes under the placeholder image */
        this.placeholderHint = I18n.get(Translations.IMAGE_PICKER_PLACEHOLDER_HINT);
        /** Upload Button Text as string */
        this.buttonText = I18n.get(Translations.IMAGE_PICKER_BUTTON_TEXT);
    ...
    class_1.prototype.render = function () {
        return (h(Host, null, h("slot", { name: "photo-picker" }, h("amplify-photo-picker", { previewSrc: this.src, handleClick: this.handlePick, headerTitle: this.headerTitle, headerHint: this.headerHint, placeholderHint: this.placeholderHint, buttonText: this.buttonText }))));
    };
    return class_1;
}());
