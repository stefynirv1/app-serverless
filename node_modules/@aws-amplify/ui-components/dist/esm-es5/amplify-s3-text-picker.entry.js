...
var AmplifyS3TextPicker = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.fallbackText = I18n.get(Translations.PICKER_TEXT);
    }
    ...
    class_1.prototype.render = function () {
        var _this = this;
        return (h(Host, null, h("amplify-s3-text", { textKey: this.src, path: this.path, level: this.level, track: this.track, identityId: this.identityId, contentType: this.contentType, fallbackText: this.fallbackText }), h("amplify-picker", { inputHandler: function (e) { return _this.handleInput(e); }, acceptValue: 'text/*' })));
    };
    return class_1;
}());
