...
const AmplifyPicker = class {
    ...
    render() {
        return (h("div", { class: "picker" }, h("slot", { name: "picker" }, h("amplify-button", null, this.pickerText)), h("input", { title: this.pickerText, type: "file", accept: this.acceptValue, onChange: e => this.inputHandler(e) })));
    }
};
