...
const AmplifyS3Text = class {
    constructor(hostRef) {
        ...
        /** Fallback content */
        this.fallbackText = core.I18n.get(Translations.Translations.TEXT_FALLBACK_CONTENT);
    }
    async watchHandler() {
        await this.load();
    }
    ...
    render() {
        return (index.h("div", null, index.h("div", { class: "text-container" }, this.src ? index.h("pre", null, this.src) : index.h("pre", null, this.fallbackText))));
    }
