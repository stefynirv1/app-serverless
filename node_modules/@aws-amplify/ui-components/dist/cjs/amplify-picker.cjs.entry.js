...
const AmplifyPicker = class {
    constructor(hostRef) {
        ...
        /** Picker button text */
        this.pickerText = core.I18n.get(Translations.Translations.PICKER_TEXT);
        /** File input accept value */
        this.acceptValue = '*/*';
    }
    render() {
        return (index.h("div", { class: "picker" }, index.h("slot", { name: "picker" }, index.h("amplify-button", null, this.pickerText)), index.h("input", { title: this.pickerText, type: "file", accept: this.acceptValue, onChange: e => this.inputHandler(e) })));
    }
};
