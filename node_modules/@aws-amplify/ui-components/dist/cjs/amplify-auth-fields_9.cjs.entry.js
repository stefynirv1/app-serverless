...
const AmplifyPhoneField = class {
    ...
    render() {
        return (index.h("div", null, index.h("amplify-form-field", { label: this.label, type: "tel", hint: this.hint, required: this.required }, index.h("div", { class: "phone-field", slot: "input" }, index.h("amplify-country-dial-code", { dialCode: this.dialCode, handleInputChange: this.handleInputChange }), index.h("amplify-input", { fieldId: this.fieldId, handleInputChange: this.handleInputChange, placeholder: this.placeholder, name: this.fieldId, value: this.value, inputProps: this.inputProps, disabled: this.disabled })))));
    }
};
