...
const Translations = require('./Translations-e37297cb.js');
...
const AmplifyPhotoPicker = class {
    constructor(hostRef) {
        ...
        /** Title string value */
        this.headerTitle = core.I18n.get(Translations.Translations.PHOTO_PICKER_TITLE);
        /** Header Hint value in string */
        this.headerHint = core.I18n.get(Translations.Translations.PHOTO_PICKER_HINT);
        /** Placeholder hint that goes under the placeholder image */
        this.placeholderHint = core.I18n.get(Translations.Translations.PHOTO_PICKER_PLACEHOLDER_HINT);
        /** Picker button text as string */
        this.buttonText = core.I18n.get(Translations.Translations.PHOTO_PICKER_BUTTON_TEXT);
    ...
    render() {
        return (index.h("div", { class: "photo-picker-container" }, index.h("amplify-section", null, index.h("div", { class: "header" }, this.headerTitle), index.h("div", { class: "header-hint" }, this.headerHint), index.h("amplify-picker", { acceptValue: 'image/*', inputHandler: this.handleInput }, index.h("div", { class: "picker-body", slot: "picker" }, this.previewState ? index.h("img", { src: `${this.previewState}` }) : index.h("amplify-icon", { name: "photoPlaceholder" }))), index.h("div", { class: "placeholder-hint" }, this.placeholderHint), index.h("amplify-button", { handleButtonClick: () => this.handleClick(this.file) }, this.buttonText))));
    }
};
